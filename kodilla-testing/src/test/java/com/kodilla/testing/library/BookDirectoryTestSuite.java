...
public class BookDirectoryTestSuite {
    ...
    @Mock
    private BookLibrary bookLibraryMock;
    ...
    public void testListBooksInHandsOfNoBooks() {
        ...
        BookLibrary bookLibrary=new BookLibrary(libraryDatabaseMock);
        //When
        LibraryUser user = new LibraryUser("Name", "LastName", "123456789");
        List<Book>resultListOf0Books=new ArrayList<>();
        when(bookLibrary.listBookInHandsOf(user)).thenReturn(resultListOf0Books);
        //Then
    ...
    public void testListBooksInHandsOf5Books() {
        ...
        when(bookLibrary.listBookInHandsOf(user)).thenReturn(resultListOf5Books);
        //When
        List<Book> theListOf5Books = bookLibrary.listBookInHandsOf(user);
        //Then
